...
// Check if user is already logged in (simple check without App)
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        // Check if this was a wishlist redirect
        if (isset($_GET['wishlist']) && $_GET['wishlist'] == '1') {
            // You could add the product to wishlist automatically here
            // Or redirect back to the product page
            $_SESSION['wishlist_redirect'] = true;
        }
